...
import { diffEditTool } from './diffEdit.js';
...
export class ToolManager {
  ...
  constructor() {
    ...
    this.registerTool(diffEditTool);
  }
...
export { listFilesTool, readFileTool, writeFileTool, bashCommandTool, searchFilesTool, diffEditTool };